...
def compare_route(req: CompareRequest):
    ...
    try:
        ...
        # preferences 전달
        preferences = req.preferences if hasattr(req, 'preferences') else []
        result = compare_routes(G, origin, destination, preferences=preferences)
        ...
        return CompareResponse(
            ...
            safest=SingleRouteResult(
                ...
                route_type="safest",
                ai_analysis=result['safest'].get('ai_analysis', "분석 정보 없음")
            )
        )
